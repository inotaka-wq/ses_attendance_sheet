...
export default function ReportPage() {
  ...
  const initialMonth = `${currentMonth.getFullYear()}-${(
    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <form id="monthly-report-form">
          ...
          {/* 1ヶ月を振り返った業務実績 */}
          <div className={styles.form_group}>
            <label htmlFor="monthly-achievement">
              1ヶ月を振り返った業務実績
            </label>
            <textarea
        ...
        {/* 上長・営業とのチャット欄 */}
        {isChatVisible && (
          <div className={styles.managerSalesChat} id="manager-sales-chat">
            <h2>上長・営業とのチャット</h2>
            ...
            />
            <button className={styles.button} onClick={sendChat}>
              送信
            </button>
          </div>
        )}

  ...
  <div className={styles.container}>
    ...
    <form id="monthly-report-form">
      ...
      <div className={styles.form_group}>
        ...
        <textarea id="project-overview" rows={4} defaultValue={""} />
      ...
      <div className={styles.form_group}>
        ...
        <textarea id="monthly-achievement" rows={6} defaultValue={""} />
        <p className={styles.note}>
          この項目は【第1開発_月報（閲覧用）】スペースに通知されます。
        </p>
      </div>
      ...
      <div className={styles.form_group}>
        ...
        <textarea id="challenges" rows={4} defaultValue={""} />
        <p className={styles.note}>
      ...
      <div className={styles.form_group}>
        ...
        <textarea id="difficulties" rows={4} defaultValue={""} />
        <p className={styles.note}>
      ...
      <div className={styles.form_group}>
        ...
        <textarea id="other-comments" rows={4} defaultValue={""} />
      </div>
      {/* 基本理念5箇条 */}
      <div className={styles.form_group}>
        <label htmlFor="principle1">基本理念5箇条の1</label>
        <input type="range" id="principle1" min={1} max={4} />
      </div>
      <div className={styles.form_group}>
        <label htmlFor="principle2">基本理念5箇条の2</label>
        <input type="range" id="principle2" min={1} max={4} />
      </div>
      <div className={styles.form_group}>
        <label htmlFor="principle3">基本理念5箇条の3</label>
        <input type="range" id="principle3" min={1} max={4} />
      </div>
      {/* ボタン */}
